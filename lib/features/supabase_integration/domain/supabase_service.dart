...
abstract class SupabaseService {
  ...
  Future<Map<String, dynamic>> updateData(String tableName, String id, Map<String, dynamic> data);
  Future<Map<String, dynamic>> deleteData(String tableName, String id);
}